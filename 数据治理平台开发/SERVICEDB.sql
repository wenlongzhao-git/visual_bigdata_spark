...
-- ----------------------------
-- Sequence structure for SEQ_SNAPSHOT_ID
-- ----------------------------
DROP SEQUENCE "SERVICEDB"."SEQ_SNAPSHOT_ID";
CREATE SEQUENCE "SERVICEDB"."SEQ_SNAPSHOT_ID"
 INCREMENT BY 1
 MINVALUE 1
...
-- ----------------------------
-- Triggers structure for table T_HDI_STREAM_AM_RECORD
-- ----------------------------
CREATE OR REPLACE TRIGGER "SERVICEDB"."T_HDI_STREAM_AM_RECORD_TRIGGER" BEFORE INSERT ON "SERVICEDB"."T_HDI_STREAM_AM_RECORD" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW ENABLE
DECLARE
	newid NUMBER;
BEGIN
	SELECT SEQ_SNAPSHOT_ID.nextval INTO newid FROM dual;
	:new.id:=newid;
END;
